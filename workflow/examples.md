...
🌐 Production URL: https://[app-name].pages.dev
✅ Health Check: PASS
...
Tambahkan kolom "discount" ke tabel invoices.

Kolom ini untuk menyimpan persentase atau nominal diskon.
```

**Catatan:** Tech Lead akan update BOTH `schema.ts` dan `index.ts`.
